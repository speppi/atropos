...
class GrammarReader:
    ...
    def __init__(self, filename, encoding = None):        
        ...
        print 'got to GrammarReader init, checking if the file has a valid header...'
    ...
    def hasValidHeader(self):
        self.reader.seek(0)
        print 'got to hasValidHeader, attempting to read string...'
    ...
    def readString(self, maxsize = -1):
        ...
        while True:
            ...
            if (char == '') or (char == '\x00\x00'):
                break
            print 'got to readString, we are failing right here; char is '+char
            result.append(char)
